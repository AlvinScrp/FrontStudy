    ...
    <div class="slider-container">
        ...
        <div class="slider-indicator">
            <div
                ...
                class="slider-indicator-item"></div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        styleObject (index) {
            const isActivate = index === this.currentIndex - 1
            const color = this.customStyle.indicatorColor
            const colorActive = this.customStyle.indicatorColorActive
            return {
        ...
        injectSliderItem () {
            ...
            const sliderItemEls = sliderEl.getElementsByClassName('slider-item')
            ...
            if (this.slideCount > 1) {
                const cloneFirst = sliderItemEls[0].cloneNode(true)
                const cloneLast = sliderItemEls[sliderItemEls.length - 1].cloneNode(true)
        ...
        transform (offset = 0, isAnim = false, handleEnd) {
            const totalOffset = -this.currentIndex * this.itemWidth + offset
