<template>
    <div class="header-info">
        <div class="user-info">
            ...
            <div class="user-right">
                <div class="line1-wrap">
                    <div class="name-wrap">
                        <p>{{userInfo.name}}</p>
                        <img v-if="userInfo.isVip" class="icon-vip" src="~assets/img/profile/icon_vip.png"/>
                    </div>
                    <img  class="icon-setting" src="~assets/img/profile/icon_profile_setting.png" alt="">
                </div>
                <div class="line2-wrap">
                    <div class="score-tag">京享值</div>
                    <div class="score-tag tag2">小白信用{{userInfo.creditScore}}<img  class="tag-arrow" src="~assets/img/profile/icon_profile_arrow_white.png" mode="" /></div>
        ...
        <div class="plus">
            <div class="plus-left">
                <img  class="plus-logo" :src="plus.logo" alt="">
                <div class="split"></div>
                <span class="plus-tip">{{plus.tip}}</span>
            </div>
            <div class="plus-right">
                <span class="look-look">立即查看</span>
                <img class="look-arrow" src="~assets/img/profile/icon_profile_arrow_black.png" alt="">
            </div>
        </div>
    </div>
</template>
