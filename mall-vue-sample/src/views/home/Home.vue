      ...
      <div slot="center">购物</div>
        ...
        <scroll-view
            ...
            <goods-feed
                ...
                :currentGoodsType="currentGoodsType"></goods-feed>
...
export default {
    ...
    methods: {
        ...
        loadGoods (refreshDom) {
            const goodsType = this.currentGoodsType
            const { page } = this.goods[goodsType]
            homeHttp
        ...
        onScroll (position) {
            ...
            const show = position.y <= -this.tabOffsetTop
