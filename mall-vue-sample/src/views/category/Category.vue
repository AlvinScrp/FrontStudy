<template>
    <div class="category">
        ...
        <div  class="body">
            <div class="tab">
                <div class="tab-item" :class="{'item-active':isActive(index)}" v-for="(tab,index) in tabs" :key="index" @click="onTabItemClick(index)"> <span class="tab-text">{{tab}}</span></div>
            </div>
            <div class="content">
                <div class="branch-section" v-for="(section,index) in branchSectionsOnShow" :key ="index">
                    <div class="section-title">{{section.title}}</div>
                    <div class="branch-container">
                        <div v-for="(branch,index) in section.branchs" :key="index" class="branch" @click="onBranchClick(branch)">
...
<script>
import { categoryData } from 'network/category.js'
export default {
    data () {
        return {
            tabs: [],
