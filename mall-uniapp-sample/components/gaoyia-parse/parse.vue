...
<template>
	...
	<!--基础元素-->
	<div class="wxParse" id="wxParse" ref="wxParse" :class="className" :style="'user-select:' + userSelect">
		...
		methods: {
			...
			getWidth() {
				return new Promise((res, rej) => {
					// #ifndef MP-ALIPAY || MP-BAIDU || APP-NVUE
					...
					uni.createSelectorQuery()
						...
						.fields({
							...
							data => {
								console.log("createSelectorQuery result:")
								console.log(data)
								res(data.width);
							}
						).exec();
