<template>
    <section class="review">
        ...
        <div class="content">
            ...
            <div class="intro">
                <div class="user-avatar" :style="imageBgStyle(this.review.topItem.userAvatar)" />
                <!--   -->
                ...
                <span class="buy-info">{{ review.topItem.buyTime }} {{ review.topItem.buyIntro }}</span>
            </div>
...
const goodScoreStr = computed(() => `${review.value.goodScore * 100.0}%`)
const imageBgStyle = (imageUrl: string) => {
    return {
...
.intro {
    ...
    .user-avatar {
        ...
        height: 0.38rem;
        border-radius: 50%;
        // background: url("https://staticimg.ngmm365.com/a865c02fb79e46e59e6e9e53495f2cc5.jpg")
        //   no-repeat;
        // background-size: 100%;
    }
    ...
    .intro-title {
        ...
        .star {
            ...
            .star-item {
                ...
                .star-item-on {
                    background: url("@/assets/img/goods/icon_star_on.png")
                        no-repeat center 0;
                    background-size: auto 100%;
                }
                .star-item-normal {
                    background: url("@/assets/img/goods/icon_star_normal.png")
                        no-repeat center 0;
                    background-size: auto 100%;
                }
                // .start-item-normal {
                //   background: url("assets/goods/icon_star_normal.png") no-repeat center 0;
