<template>
    <div class="order">
        <div class="top-line-box">
            <div class="order-item" v-for="(order,index) in myOrder?.orderList " :key="index">
                <div class="order-icon-wrap">
                    <img class="order-icon" :src="order.icon" />
            ...
            <div class="order-item order-all">
                <div class="order-icon-wrap">
                    <img class="order-icon" :src="myOrder?.orderAllIcon" />
                </div>
        ...
        <div class="logistics">
            ...
            >
                <swiper-slide
                    v-for="(logisticsInfo,index) in myOrder?.logisticsList"
                    :key="index"
                    class="swiper-slide"
                >
...
import { MyOrderBean } from '@/common/bean'
SwiperCore.use([Autoplay, EffectCoverflow, EffectCube, Pagination])

const myOrder = ref<MyOrderBean>()
...
onMounted(() => {
    setTimeout(() => {
        myOrder.value = profileData.myOrder
    }, 200)
})
</script>
